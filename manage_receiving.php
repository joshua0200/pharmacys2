						...
						<div class="row">
							<div class="form-group col-md-5">
								...
								<div class="">
									...
									<input type="text" class="form-control mb-3" name="batch" required style="max-width: 300px" placeholder="Enter Batch #">
								</div>
							</div>
						</div>
						<hr>
								...
								<tbody>
									...
									?>
										<tr class="item-row">
											...
											<td>
												<input default="None" type="date" name="expiry_date[]" class="text-right" value="<?= ($row['expiry_date'] != null) ? date("Y-m-d", strtotime($row['expiry_date'])) : '' ?>" required>
											</td>
											<td>
											...
											<td>
												<div class="row">
													...
													<div class="col">
														<small><?= $row['selling_mode'] ?>/s</small>
													</div>
												</div>
						...
						<div class="row">
							<div class="col-lg-12">
								...
								<div class="text-right">
									<button class="btn btn-primary   ">Receive Order</button>
								</div>
