						...
						<div class="row">
							<table class="table table-bordered" id="list">
								...
								<tbody>
									...
									?>
										<tr class="item-row">
											<td><input type="text" name="id" value="<?php echo isset($_GET['id']) ? $_GET['id'] : '' ?>"></td>
											<td><input type="text" name="ref_no" value="<?php echo isset($ref_no) ? $ref_no : '' ?>"></td>
											<td>
												<input default="None" type="date" name="expiry_date[]" class="text-right" value="<?php echo date("Y-m-d",strtotime($row['expiry_date'])) ?>">
											</td>
											<td>
